...
- For a one-off artifact or result, use the registered `nano-banana` service in the `runapi` CLI. If the installed command catalog does not list it, stop and report the missing service instead of inventing a command.
...
runapi nano-banana <operation> --help
curl --fail --location https://runapi.ai/docs/api/nano-banana/<operation>.md --output contract.md
```
...
```shell
runapi nano-banana <operation> --async --input-file request.json > task.json
...
```shell
runapi wait "$task_id" --service nano-banana --action <operation> > result.json
```
...
- SDK integration: https://github.com/runapi-ai/nano-banana-sdk

## Variants
- `nano-banana`: https://runapi.ai/models/nano-banana/nano-banana.md
- `nano-banana-2`: https://runapi.ai/models/nano-banana/2.md
- `nano-banana-2-lite`: https://runapi.ai/models/nano-banana/2-lite.md
- `nano-banana-edit`: https://runapi.ai/models/nano-banana/edit.md
- `nano-banana-pro`: https://runapi.ai/models/nano-banana/pro.md
